...
public class FreeMarkerAutoFragmentConfig {
    ...
    private static final FragmentTemplate FRAGMENT_TEMPLATE_BUILDER = FragmentTemplate.FULLY_AUTOMATIC;
    ...
    enum FragmentTemplate {
        ...
        FULLY_AUTOMATIC {
            @Override
            Template build(String macroName, String viewName, Template baseTemplate) throws IOException {
                Template fragmentTemplate = newTemplate("<@" + macroName + " />", viewName, baseTemplate);
